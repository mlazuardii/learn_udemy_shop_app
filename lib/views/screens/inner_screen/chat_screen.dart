...
class ChatScreen extends StatefulWidget {
  ...
  const ChatScreen({super.key, required this.sellerId, required this.buyerId, required this.productId, required this.productName});
  ...
  void _sendMessage() async {
    ...
    if (message.isNotEmpty) {
      await _firestore.collection('chats').add({
        ...
        'sellerPhoto':(vendorDoc.data() as Map<String, dynamic>)['storeImageUrl'],
